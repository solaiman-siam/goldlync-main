...
const CoinPurchase = () => {
  return (
    <>
      ...
      <section className="bg-[#FFF2EB] py-6 md:p-6 xl:p-28">
        <Container>
          <div className="container grid grid-cols-1 gap-8 md:grid-cols-2 xl:gap-32">
            {/* images */}
            <div className="left flex-1">
              <h4 className="mb-7 w-full text-2xl font-bold text-[#242424] md:text-3xl">
                Custome Purchase
              </h4>
              <figure className="xl:h-[400px] xl:w-[500px]">
                <img src={coinImg} alt="" />
              </figure>
            </div>
            {/* form */}
