    ...
    <>
      ...
      <section className="container border-t py-[70px]">
        <div className="flex justify-between gap-8">
          ...
          <div className="card flex gap-4">
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M85.5 21.375H66.5V11.875L57 2.375H38L28.5 11.875V21.375H9.5C4.275 21.375 0 25.65 0 30.875V83.125C0 88.35 4.275 92.625 9.5 92.625H85.5C90.725 92.625 95 88.35 95 83.125V30.875C95 25.65 90.725 21.375 85.5 21.375ZM57 21.375H38V11.875H57V21.375Z"
                fill="#FF6A16"
              />
            </svg>
            <div ref={counterRef}>
          ...
          <div className="card flex gap-4">
            ...
            >
              <path
                d="M84.375 90.625H54.6875V96.875H84.375V90.625Z"
                fill="#FF6A16"
              />
              <path
                d="M84.375 31.6812C84.3713 28.4815 83.0986 25.414 80.836 23.1514C78.5735 20.8889 75.5059 19.6162 72.3063 19.6125H71.55C71.227 19.6126 70.9118 19.5126 70.6479 19.3262C70.3841 19.1399 70.1845 18.8763 70.0766 18.5718C69.3181 16.4257 67.9363 14.5547 66.1081 13.1987C64.2799 11.8426 62.0885 11.0631 59.8146 10.9601C57.5407 10.857 55.2878 11.4351 53.3444 12.6203C51.4011 13.8054 49.8557 15.5437 48.9062 17.6125C48.8008 17.8422 48.6413 18.0429 48.4412 18.1974C48.2412 18.3519 48.0067 18.4556 47.7578 18.4995C47.5089 18.5434 47.253 18.5263 47.0122 18.4497C46.7713 18.373 46.5527 18.2391 46.375 18.0593C45.3137 16.9777 44.0467 16.1192 42.6487 15.5345C41.2506 14.9498 39.7498 14.6506 38.2344 14.6546C35.6034 14.6614 33.0545 15.5711 31.0139 17.2318C28.9732 18.8925 27.5646 21.2034 27.0234 23.7781C26.9515 24.1434 26.7506 24.4706 26.4575 24.7001C26.1643 24.9296 25.7984 25.046 25.4266 25.0281L25 25C22.5136 25 20.129 25.9877 18.3709 27.7458C16.6127 29.504 15.625 31.8886 15.625 34.375C15.625 36.8614 16.6127 39.2459 18.3709 41.0041C20.129 42.7622 22.5136 43.75 25 43.75H72.3063C75.5059 43.7462 78.5735 42.4735 80.836 40.211C83.0986 37.9485 84.3713 34.8809 84.375 31.6812ZM64.0625 28.125V25C66.5481 25.0024 68.9313 25.991 70.6889 27.7486C72.4465 29.5062 73.435 31.8893 73.4375 34.375H70.3125C70.3125 32.7174 69.654 31.1276 68.4819 29.9555C67.3098 28.7834 65.7201 28.125 64.0625 28.125ZM70.3125 37.5H73.4375V40.625H70.3125V37.5Z"
                fill="#FF6A16"
              />
              <path
                d="M90.6251 20.3125C89.7963 20.3125 89.0014 20.6417 88.4153 21.2278C87.8293 21.8138 87.5001 22.6087 87.5001 23.4375V46.875C87.5 47.0975 87.4525 47.3174 87.3606 47.5201C87.2687 47.7227 87.1346 47.9034 86.9672 48.05L74.5032 58.9562L66.7297 66.7297L64.5204 64.5203L74.6766 54.3641C75.1936 53.8244 75.4786 53.1037 75.4706 52.3565C75.4625 51.6092 75.1621 50.8948 74.6337 50.3664C74.1053 49.8379 73.3909 49.5375 72.6436 49.5295C71.8963 49.5215 71.1757 49.8065 70.636 50.3234L58.0797 62.8797C57.4978 63.4587 57.0365 64.1474 56.7224 64.9058C56.4084 65.6643 56.2478 66.4775 56.2501 67.2984V78.4188C56.2471 79.0901 56.3526 79.7576 56.5626 80.3953L58.9391 87.5H81.2501V74.0859C81.2502 72.3513 81.7316 70.6508 82.6407 69.1734L92.8235 52.6266C93.4305 51.6398 93.7513 50.5038 93.7501 49.3453V23.4375C93.7501 22.6087 93.4208 21.8138 92.8348 21.2278C92.2487 20.6417 91.4539 20.3125 90.6251 20.3125Z"
                fill="#FF6A16"
              />
              <path
                d="M25.3234 50.3234C24.7885 50.8597 24.4882 51.5863 24.4882 52.3438C24.4882 53.1012 24.7885 53.8278 25.3234 54.3641L35.4797 64.5203L33.2703 66.7297L25.4969 58.9562L13.0328 48.05C12.8655 47.9034 12.7314 47.7227 12.6395 47.5201C12.5476 47.3174 12.5 47.0975 12.5 46.875V23.4375C12.5 22.6087 12.1708 21.8138 11.5847 21.2278C10.9987 20.6417 10.2038 20.3125 9.375 20.3125C8.5462 20.3125 7.75135 20.6417 7.16529 21.2278C6.57924 21.8138 6.25 22.6087 6.25 23.4375V49.3516C6.24879 50.51 6.56958 51.6461 7.17657 52.6328L17.3594 69.1797C18.2674 70.6552 18.7487 72.3534 18.75 74.0859V87.5H41.0609L43.4375 80.3953C43.6474 79.7576 43.7529 79.0901 43.75 78.4188V67.2984C43.7523 66.4775 43.5917 65.6643 43.2776 64.9058C42.9636 64.1474 42.5022 63.4587 41.9203 62.8797L29.3641 50.3234C28.8278 49.7885 28.1012 49.4882 27.3438 49.4882C26.5863 49.4882 25.8598 49.7885 25.3234 50.3234Z"
                fill="#FF6A16"
              />
              <path
                d="M45.3125 90.625H15.625V96.875H45.3125V90.625Z"
                fill="#FF6A16"
              />
            </svg>
            <div ref={counterRef}>
      ...
      <section className="container">
        <div className="flex justify-between gap-8">
          ...
          <div className="right flex-1 rounded-xl bg-[#FFF2EB] p-12">
            <div className="mb-6 flex items-center gap-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="50"
