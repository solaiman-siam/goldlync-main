...
const Message = () => {
  ...
  return (
    <Container>
      <div className="mb-[2.5vh] mt-14">
        <h1 className="mb-7 text-left text-3xl font-bold leading-[120%]">
          Chat
        </h1>
          ...
          <div className="left col-span-2 flex h-[80vh] flex-col rounded-lg border px-5 py-7 shadow-2xl">
            ...
            <div className="flex-grow space-y-5 overflow-y-auto pr-4">
              {Array(12)
                ...
                .map((_, idx) => (
                  <div
                    className="flex gap-2 rounded bg-[#FFF2EB] p-4"
                    key={idx}
                  >
                ...
                .map((_, idx) => (
                  <div className="p-4" key={idx}>
                    ...
                    <p className="mx-12 text-[#262627]/70">
                      ...
                      repellat accusamus tempora? Officia ullam labore eaque
                      quasi asperiores quidem, quaerat, cupiditate culpa
                      aspernatur, alias aut nesciunt laudantium blanditiis.
                    </p>
                  </div>
                ))}
            </div>
